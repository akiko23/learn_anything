...
Revision ID: b8a831402314
Revises: 
Create Date: 2024-11-08 22:34:00.877712
...
def upgrade() -> None:
    ...
    sa.Column('for_role', sa.Enum('STUDENT', 'MENTOR', 'TEACHER', 'BOT_OWNER', name='userrole'), nullable=True),
    ...
    sa.Column('role', sa.Enum('STUDENT', 'MENTOR', 'TEACHER', 'BOT_OWNER', name='userrole'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
