...
from learn_anything.domain.entities.course.errors import CourseDoesNotExistError, RegistrationForCourseDoesNotExistError
from learn_anything.domain.entities.course.models import CourseID
from learn_anything.domain.entities.course.rules import decrement_course_registrations_number
