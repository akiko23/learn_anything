...
from learn_anything.domain.entities.course.errors import CourseDoesNotExistError, UserAlreadyRegisteredForCourseError
from learn_anything.domain.entities.course.models import CourseID
from learn_anything.domain.entities.course.rules import increment_course_registrations_number, create_registration_for_course
