...
from learn_anything.course_platform.application.interactors.course.publish_course import PublishCourseInteractor, PublishCourseInputData
...
@router.callback_query(F.data.startswith('publish_course-'))
