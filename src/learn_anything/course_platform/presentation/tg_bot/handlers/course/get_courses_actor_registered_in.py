...
from learn_anything.course_platform.application.interactors.course.get_many_courses import GetActorRegisteredCoursesInteractor, \
...
from learn_anything.course_platform.presentors.tg_bot.keyboards.course.many_courses import get_actor_registered_courses_keyboard, \
