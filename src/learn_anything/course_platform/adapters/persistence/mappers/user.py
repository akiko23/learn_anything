...
from learn_anything.course_platform.adapters.persistence.tables.user import users_table, auth_links_table
...
from learn_anything.course_platform.domain.entities.user.models import UserID, User, AuthLink
